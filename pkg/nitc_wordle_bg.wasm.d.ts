...
export const __wbg_get_guessresult_letter: (a: number) => number;
export const __wbg_get_guessresult_state: (a: number) => number;
export const __wbg_guessresult_free: (a: number, b: number) => void;
...
export const wordlegame_new: () => number;
export const wordlegame_submit_guess: (a: number, b: number, c: number) => [number, number, number];
